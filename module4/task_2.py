...
rus_exam = int(input('Введите кол-во баллов по русскому языку: '))
math_exam = int(input('Введите кол-во баллов по математике: '))
inf_exam = int(input('Введите кол-во баллов по информатике: '))
sum_exam = rus_exam + math_exam + inf_exam
if sum_exam >= 270:
