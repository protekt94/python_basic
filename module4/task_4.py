...
second_chair = int(input('Введите стоимость второго стула: '))
third_chair = int(input('Введите стоимость третьего стула: '))
sum_chair = first_chair + second_chair + third_chair
if sum_chair > 10000:
  sum_chair = sum_chair - sum_chair * 0.1
  print('Итоговая сумма с учетом скидки:', sum_chair)
else:
  print('Итоговая сумма:',sum_chair)