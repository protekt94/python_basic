...
start_cut = int(input('Введите начало отрезка: '))
end_cut = int(input('Введите конец отрезка: '))
step = int(input('Введите шаг: '))
for number in range(end_cut, start_cut - 1, step):
  y = number ** 3 + 2 * number ** 2 - 4 * number + 1
  print('В точке {} функция равна {}'.format(number, y))
