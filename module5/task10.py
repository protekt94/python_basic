...
# второй —  при выполнении усло7вия выводится сообщение:
# «Посылку получить нельзя».

time = int(input('Введите время в часах: '))
if (time < 8 or time > 22) or (time == 10 or time == 18) or (time == 14 or time == 15):
  print('Время', time, 'Посылку получить нельзя')
else:
  print('Время', time, 'Можно получить посылку')